    ...
    <html lang="en">
      ...
      <body>
        ...
        <nav className="main-nav">
          ...
          <a href="https://github.com/Flexicom-Industries-Pvt-Ltd/Plascom-TripFlag/releases/latest/download/TripFlag%20Setup%201.0.1.exe" className="nav-item" style={{ marginTop: 'auto', marginBottom: '1rem', background: '#f8fafc', color: '#0f172a', fontWeight: '600' }} title="Download Desktop App">
            <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
              <path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4" />
