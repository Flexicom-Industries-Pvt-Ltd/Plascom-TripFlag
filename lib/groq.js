...
Examples:
- "flag if fuel is above 50" → {"field_name": "fuel", "operator": "gt", "value": "50", "value_end": null, "severity": "warning", "label": "Fuel above 50"}
- "mark trips where driver name is missing" → {"field_name": "driver_name", "operator": "is_empty", "value": "", "value_end": null, "severity": "critical", "label": "Driver name is missing"}
- "highlight if distance is between 100 and 500" → {"field_name": "distance", "operator": "between", "value": "100", "value_end": "500", "severity": "warning", "label": "Distance between 100 and 500"}
